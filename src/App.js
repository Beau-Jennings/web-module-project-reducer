...
import { addMemoryValue, addMemoryReturnValue, applyNumber, changeOperation, clearDisplay, memoryClear } from './actions';
...
function App() {
  ...
  const handleAddMemoryValue = (e) => {
    dispatch(addMemoryValue(e));
  };

  const handleAddMemoryReturnValue = (e) => {
    dispatch(addMemoryReturnValue(e));
  };
          ...
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={() => (
                handleAddMemoryValue()
              )} />
              <CalcButton value={"MR"} onClick={() => (
                handleAddMemoryReturnValue()
              )} />
